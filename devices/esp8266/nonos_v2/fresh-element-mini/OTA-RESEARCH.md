...
these images using layout values from [`profile.json`](profile.json). The V2
bridge builder is part of [ESPHome
Kickstart](https://github.com/libretiny-eu/esphome-kickstart) rather than this
server project.
